 ...
 *   Space ............................ jump
 *   F ................................ attack (shot + reload per swing)
...
export default function MinecraftGamePage() {
  ...
  useEffect(() => {
    ...
    // pours.
    const rain: RainHandle = createRain(scene);
    ...
    function onAnimFinished() {
      ...
      // reload inside its own duration), restarts included.
  ...
  return (
    <main className="fixed inset-0 overflow-hidden bg-[#bfd1e5]">
      ...
      {/* ===== top-right row: MAXIMIZE (fullscreen) + sound (also the M key) =====
           padded with the safe-area inset so notched phones keep both
           buttons clear of the status bar while the canvas runs under it */}
      <div
